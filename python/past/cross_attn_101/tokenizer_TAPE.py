...
if moder == "all":
    ...
    path = "/Users/mac/Desktop/t3_mnt/transformer_tape_dnabert/data/"
    input = f"/Users/mac/Documents/transformer_tape_dnabert/data/unknown_protein_all/"
elif moder == "attn_ana":
...
def main(arglist):  # gnum:process_id, group:protein_group
    ...
    for i in thisrange:
        ...
        if group is not None:  # when unknown
